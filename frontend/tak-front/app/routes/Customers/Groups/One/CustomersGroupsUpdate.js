...
const CustomersGroupsUpdate = ({  createOne = () => {}, refreshAll = () => {}, refreshOne = () => {}, recoilKey}) => {
    ...
    * */
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            if (formik.isValid && formik.dirty) {
                ...
                const re = await Promise.all([agent.CustomerGroup.update({
                    ...valuesWithoutMeta
                })]);
    ...
    return (
        ...
        >
            <Container>
                <Card className="mb-3">
                    <CardHeader> <DetailHeaderWrapper id={formik.values[PK_NAME]} name={formik.values.customerGroupIdx}/></CardHeader>
                    <CardBody>
...
export default React.memo(CustomersGroupsUpdate);
