...
const PK_NAME = "groupAssignListIdx";
const CustomersGroupAssignList = ({recoilKey, ...props}) => {
    ...
    * */
    ...
    const [userSelectModalLocalOpen, setUserSelectModalLocalOpen] = useState(false);
    ...
    * */
    ...
    const handleUserChangeAction = () => {
        ...
        setUserSelectModalLocalOpen(true)
    };
    ...
    * */
    ...
    const handleUserSelected = (originalUserRow) => {
        ...
        if (confirm(confirmationMessage)) {
            ...
            setUserSelectModalLocalOpen(false);
        }
    }
    /*
    ...
    * */
    return (
        <Fragment>
            <UserSelectModalLocal
                                 onUserSelected={handleUserSelected}
                                 userSelectModalLocalOpen={userSelectModalLocalOpen} setUserSelectModalLocalOpen={setUserSelectModalLocalOpen}/>
            <LoadingOverlay
...
export default CustomersGroupAssignList;