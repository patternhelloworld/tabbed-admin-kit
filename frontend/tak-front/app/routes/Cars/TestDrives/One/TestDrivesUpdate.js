...
const TestDrivesUpdate = ({createOne = () => {}, refreshAll = () => {}, refreshOne = () => {}, recoilKey, PK_NAME, injectedGlobalReadOnly = null}) => {
    ...
    * */
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            if (formik.isValid && formik.dirty) {
                ...
                const re = await Promise.all([agent.TestDrive.update({
                    ...valuesWithoutMeta,
                    startDate: formatDateTimeWrapper(valuesWithoutMeta.startDate),
                    endDate: formatDateTimeWrapper(valuesWithoutMeta.endDate),
    ...
    const onDelete = async (e) => {
        ...
        try {
            ...
            const re = await Promise.all([agent.TestDrive.delete({
                ...
                <CardBody>
                    <Form className="mt-4 mb-3">
                        <TestDrivesCommon formik={formik} globalReadOnly={globalReadOnly}
                            ...
                            <Flex p="md" justify="center" className={classNames('mt-5', { 'd-none': globalReadOnly })}>
                                <Flex gap="lg">
                                    <ButtonWrapper
                                        color={"info"}
                                        btnText={"신규"}
...
export default React.memo(TestDrivesUpdate);
