...
import {
    getVinInfoOptions,
    getVinTypeOptions, getGenderOptions,
    getNationalityOptions,
    getPurchasePlanOptions
} from "../../../../shared/enums";
import {CodeGeneralUtil, isValidObject} from "../../../../shared/utils/utilities";
import {VinsCommonUtil} from "../common";
import VinListCommon from "./VinsCommon";
import VinsCommon from "./VinsCommon";
import {ActionIcon, Tooltip, Box,  Flex, Menu, Text, Title} from '@mantine/core';

// true && false : false , true || false : true
const VinsUpdate = ({createOne = () => {}, refreshAll = () => {}, refreshOne = () => {}, recoilKey, PK_NAME, injectedGlobalReadOnly = null}) => {
    ...
    * */
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            if (formik.isValid && formik.dirty) {
                ...
                const re = await Promise.all([agent.Vin.update({
                    ...valuesWithoutMeta,
    ...
    const onDelete = async (e) => {
        ...
        try {
            ...
            const re = await Promise.all([agent.Vin.delete({
    ...
    useEffect(() => {
        ...
        const nullOrUndefinedSafeOne = VinsCommonUtil.createNullOrUndefinedSafeOne(one);
    ...
    return (
        ...
        >
            <Card className="mb-3">
                <CardHeader>
                    <DetailHeaderWrapper id={formik.values.vinIdx} />
                </CardHeader>
                <CardBody>
                    <Form className="mt-4 mb-3">
                        <VinsCommon formik={formik} globalReadOnly={globalReadOnly}
                                             onKeyValueChangeByEvent={onKeyValueChangeByEvent}
                                             onKeyValueChangeByNameValue={onKeyValueChangeByNameValue}
                                             PK_NAME={PK_NAME}></VinsCommon>
...
export default React.memo(VinsUpdate);
