...
import VinSelectListLocal from "../../../../shared/components/select-list/VinSelectListLocal";

// true && false : false , true || false : true
const DealerStocksCreate = ({
                                 createOne = () => {
                                 }, refreshAll = () => {
    }, refreshOne = () => {
    }, recoilKey, PK_NAME
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            if (formik.isValid && formik.dirty) {
                ...
                const re = await Promise.all([agent.DealerStock.create({
                    ...valuesWithoutMeta,
                ...
                <CardBody>
                    <Form className="mt-4 mb-3">
                        ...
                        <Label className="right">
                            차대 번호 선택 <mark>{formik.errors.uniqueStockIdxIndex ? " : " + formik.errors.uniqueStockIdxIndex : ""}</mark>
                        </Label>
                        <VinSelectListLocal onKeyValueChangeByNameValue={onKeyValueChangeByNameValue} />
...
export default React.memo(DealerStocksCreate);
