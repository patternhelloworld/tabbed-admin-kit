...
import ExtColorCreate from './One/ExtColorCreate';
import ExtColorUpdate from './One/ExtColorUpdate';
...
const CodesExtColorList = ({ recoilKey }) => {
        ...
        <Fragment>
            ...
            >
                ...
                <Col xl={!isValidObject(one) ? 12 : 6}>
                    ...
                    <Col className={"mt-2"}>
                        {isCreateOne(one,PK_NAME) ? <ExtColorCreate refreshAll={refreshAll} refreshOne={refreshOne} recoilKey={recoilKey}/>
                            : isUpdateOne(one,PK_NAME) ?
                                <ExtColorUpdate createOne={createOne} refreshAll={refreshAll} refreshOne={refreshOne} recoilKey={recoilKey}/> : ""}
                    </Col>
                </Row>
            </LoadingOverlay>
        </Fragment>)
...
export default CodesExtColorList;