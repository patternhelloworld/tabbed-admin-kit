...
const ExtColorCreate = ({refreshAll = ()=>{}, refreshOne = ()=>{}, recoilKey}) => {
    ...
    const handleCreateOrUpdate = async (e) => {
        ...
        try {
            ...
            if (formik.isValid && formik.dirty) {
                ...
                const re = await Promise.all([agent.ExtCode.create({
                    ...valuesWithoutMeta
                })]);
            ...
            <Card className="mb-3">
                ...
                <CardBody>
                    <Form className="mt-4 mb-3">
                        <FormGroup row>
                            <Label for="code" sm={2} className="right">
                                코드
                            </Label>
                            <Col sm={10}>
                                <Input
...
export default React.memo(ExtColorCreate);
