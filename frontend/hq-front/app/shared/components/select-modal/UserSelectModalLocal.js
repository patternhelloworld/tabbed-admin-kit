...
import getSettingsUsersColumns from "../../../routes/Settings/Users/columns";
import {Col, Row} from "../../../components";
import classNames from "classnames";
import {updateCustomersUserManager} from "../../../routes/Customers/List/othersUpdateFuncs";
...
const UserSelectModalLocal = ({userSelectModalOpen = false, setUserSelectModalOpen = ()=> {}, onUserSelected = undefined, ...props}) => {
    ...
    const handleBtnClickAction = () => {
        ...
        onUserSelected(table.getSelectedRowModel().rows[0].original)
    }
...
export default React.memo(UserSelectModalLocal);