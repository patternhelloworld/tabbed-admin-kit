package io.github.patternhelloworld.common.config.logger.common;
    ...
    private String requestLogging()  {
        ...
        while (headerNames.hasMoreElements()) {
            ...
            if(headerName.equals("user-agent") || headerName.equals("authorization")
                    || headerName.equals("content-type")|| headerName.equals("content-length") || headerName.equals(CustomHttpHeaders.APP_TOKEN)){
