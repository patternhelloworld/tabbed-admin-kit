package io.github.patternhelloworld.common.config.response.error.message;

import lombok.Getter;
import org.springframework.http.HttpStatus;

@Getter
public enum GeneralExceptionMessage implements ExceptionMessageInterface {
    ...
    GeneralExceptionMessage(String code, String message, String userMessage, HttpStatus status) {
        this.code = code;
