package com.autofocus.pms.hq.integration.auth;
...
public class UserIntegrationTest {
    ...
    public void test_아이디_또는_패스워드_틀리게_로그인_그리고_Client_ID_Secret_다르게_로그인_ORIGINAL() throws Exception {
       ...
       // assertEquals(userMessage, DefaultSecurityUserExceptionMessage.AUTHENTICATION_LOGIN_FAILURE.getMessage());
        ...
        assertEquals(userMessage, DefaultSecurityUserExceptionMessage.AUTHENTICATION_WRONG_CLIENT_ID_SECRET.getMessage());
        ...
        assertEquals(userMessage, DefaultSecurityUserExceptionMessage.AUTHENTICATION_WRONG_GRANT_TYPE.getMessage());
