package com.autofocus.pms.hq.domain.common.carmodeldetail.dao;
...
public interface CarModelDetailRepository extends JpaRepository<CarModelDetail, Integer>, QuerydslPredicateExecutor<CarModelDetail> {
    ...
    @Query("SELECT new com.autofocus.pms.hq.domain.common.carmodeldetail.dto.CarModelDetailResDTO$CarModelDetailSearch(cmd.carModelDetailIdx, cmd.name, cmd.code, cmd.motorType, cmd.carName) " +
