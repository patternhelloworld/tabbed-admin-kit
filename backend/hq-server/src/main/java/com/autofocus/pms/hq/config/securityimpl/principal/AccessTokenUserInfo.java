package com.autofocus.pms.hq.config.securityimpl.principal;
...
/*
* 	해당 클래스는 다른 프로젝트들이 있을 경우, 동일 하게  com.autofocus.pms.hq.interestedtreatmentpart.dto.security 에 위치해야 한다.
* */
