package com.autofocus.pms.hq.domain.common.user.api;
...
import com.autofocus.pms.hq.config.logger.module.ResponseSuccessLogConfig;
...
public class UserApi {
    ...
    public GlobalSuccessPayload<?> getUserSelf(@AuthenticationPrincipal AccessTokenUserInfo accessTokenUserInfo,
        ...
        if(authorizationHeader == null){
            throw new CustomOauth2AuthenticationException(DefaultSecurityUserExceptionMessage.AUTHENTICATION_TOKEN_FAILURE.getMessage());
        }
