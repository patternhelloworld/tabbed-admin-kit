package com.autofocus.pms.hq.config.securityimpl.service.permission;

import com.autofocus.pms.common.config.HttpMethodType;
...
import com.autofocus.pms.hq.config.securityimpl.service.userdetail.UserDetailsServiceImpl;
    ...
    * */
    public boolean isAuthenticated() throws OAuth2AuthenticationException {
        ...
        if(authentication == null || authentication instanceof AnonymousAuthenticationToken){
            throw new CustomOauth2AuthenticationException(DefaultSecurityUserExceptionMessage.AUTHENTICATION_TOKEN_NOT_FOUND.getMessage());
        }
        return true;
    }
