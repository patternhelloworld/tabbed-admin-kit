...
@MapperScan(basePackages = {"io.github.patternhelloworld.tak.mapper"}, sqlSessionFactoryRef = "crmSqlSessionFactory")
@EnableJpaRepositories(
        basePackages = {"io.github.patternhelloworld.tak.domain.crm"},
...
public class CrmDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean crmEntityManager() {
        ...
        em.setPackagesToScan("io.github.patternhelloworld.tak.domain.crm", "io.github.patternhelloworld.tak.config.securityimpl", "io.github.patternknife.securityhelper.oauth2.api");
